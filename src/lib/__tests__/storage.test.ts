...
describe('SettingsStorage', () => {
  ...
  describe('validateApiKey', () => {
    it('should set lastApiKeyValidation timestamp when API key is validated successfully', () => {
      ...
      expect(settings.lastApiKeyValidation).toBeGreaterThanOrEqual(beforeTimestamp);
  ...
  describe('loadSettings', () => {
    it('should handle missing timestamp fields in stored settings', () => {
      ...
      localStorage.setItem('image-to-prompt-settings', JSON.stringify(legacySettings));
