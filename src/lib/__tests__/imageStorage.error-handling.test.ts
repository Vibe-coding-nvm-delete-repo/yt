...
describe("ImageStorage Error Handling", () => {
  ...
  describe("storeImage error handling", () => {
    it("should handle storage errors gracefully", async () => {
      ...
      await expect(
        imageStorage.storeImage(mockFile, "test-id"),
      ).rejects.toThrow();
    });
  ...
  describe("getImage error handling", () => {
    it("should return null on database error", async () => {
      jest
        .spyOn(imageStorage as any, "initDB")
        .mockRejectedValue(new Error("DB not accessible"));
  ...
  describe("getImageUrl error handling", () => {
    ...
    it("should log error when URL retrieval fails", async () => {
      ...
      jest
        .spyOn(imageStorage, "getImage")
        .mockRejectedValue(new Error("Invalid image ID"));
  ...
  describe("removeImage error handling", () => {
    it("should throw error on removal failure", async () => {
      jest
        .spyOn(imageStorage as any, "initDB")
        .mockRejectedValue(new Error("Cannot access database"));
  ...
  describe("getTotalSize error handling", () => {
    it("should return 0 on error", async () => {
      jest
        ...
        .mockRejectedValue(new Error("Cannot calculate size"));
  ...
  describe("cleanup error handling", () => {
    it("should not throw on cleanup failure", async () => {
      jest
        ...
        .mockRejectedValue(new Error("Cannot determine size"));
