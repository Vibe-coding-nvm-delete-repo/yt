...
describe("Settings Domain Façade", () => {
  ...
  describe("getSettings", () => {
    it("should return current settings", () => {
      ...
      expect(settings).toHaveProperty("selectedVisionModels");
      ...
      expect(settings).toHaveProperty("preferredModels");
      expect(settings).toHaveProperty("pinnedModels");
      expect(settings).toHaveProperty("lastApiKeyValidation");
      expect(settings).toHaveProperty("lastModelFetch");
    });
  });
